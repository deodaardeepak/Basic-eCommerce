...
?>
   ...
   <?php if(!isset($_SESSION['Username'])) 
      ...
      header('location: /efinal/registrations/logincolg.php');
         } 
          ...
          echo'<span>Welcome ';
          echo $na;
          echo '</span> &nbsp;&nbsp;<a href="logout.php"><button  style="background-color: #3bafda;color: #ffffff;text-decoration: none;"  type="reset" class="btn primary"><span class="glyphicon glyphicon-refresh"></span>Logout</button></a>   ';
        }
        ?>
...
<div id="wrapper">
	...
	<div id="content">
		<div id="productlist">
			...
			{
				echo '<a rel="facebox" href="orderpage.php?id='.$row['id'].'&trnasnum='.$transnum.'"><img src="img/products/'.$row['img'].'" alt="'.htmlspecialchars($row['name']).'" width="200" height="200" class="pngfix" /></a>';
