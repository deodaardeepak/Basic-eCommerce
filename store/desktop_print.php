...
<img src="../images/logo.png" width="100" height="100" style="float:left;"><strong>Ecommerce System</strong><br>Cachebuffer@ Mumbai City<br>Email Us: infotech.cachebuffer.com<br>Contact: <a href="#">(9594)035-468</a> 
<br><br><br><br>
<?php
include('connect.php');
		$id=$_GET['id'];
		...
		while($row = mysql_fetch_array($result))
			{
				...
				echo 'note: if the Delivery Type is Outside Mumbai It has an 500 delivery charge ';
