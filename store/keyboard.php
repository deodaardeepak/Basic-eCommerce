...
function getXMLHTTP() { //fuction to return the xml http object
	...
	function getState(countryId) {		
		...
		var strURL="keyboard_findState.php?country="+countryId;
		var req = getXMLHTTP();
	...
	function getCity(countryId,stateId) {		
		var strURL="keyboard_findCity.php?country="+countryId+"&state="+stateId;
		var req = getXMLHTTP();
...
<div id="wrapper">
	...
	<div id="content">
		<div id="productlist">
			...
			<?php
			require "connect.php";
			$result = mysql_query("SELECT * FROM keyboard_shop");
			while($row=mysql_fetch_assoc($result))
			{
				echo '<a rel="facebox" href="keyboard_orderpage.php?id='.$row['id'].'&trnasnum='.$transnum.'"><img src="img/products/'.$row['img'].'" alt="'.htmlspecialchars($row['name']).'" width="500" height="200" class="pngfix" /></a>';
		...
		<div id="orderlist">
			<table width="100%" border="1" cellpadding="2" cellspacing="2">
				...
				$result3 = mysql_query("SELECT * FROM orders WHERE confirmation='$transnum'");
					while($row3 = mysql_fetch_array($result3))
						{
						echo '<tr>';
						echo '<td><a href="keyboard_deleteorder.php?id='.$row3['id'].'" id="'.$row3['id'].'" class="delbutton" title="Click To Delete"><img src="img/delete.png"></a></td>';
			...
			<form method="post" action="keyboard_personalinfo.php" name="form1" onsubmit="return validateForm()">
